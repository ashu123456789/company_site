...
<div class="bg-services d-flex align-items-center text-white">
        <div class="container">
            <div class="row">
                ...
                <h1 class="pt-1"><img src="{{ env('APP_CDN_URL') }}/images/technology/ux-design.png" alt="UX design" title="UX design" class="services-image"> UX/UI DESIGN</h1>
                ...
                <div class="col-xl-6 col-lg-6 col-md-5 px-0 banner-right-img text-center" data-aos="fade-left">
                    <img alt="UI UX" title="UI UX" src="{{asset('images/technology/ui-ux-design-banner.png')}}" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
