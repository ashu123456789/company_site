<div class="col-lg-7 col-md-12 col-sm-12 col-12 Q-form">
                    ...
                    <text class="form-control list_title" name="type" id="type" readonly></text>
                    </div>
                    </div>
                    </div>
                    </div>--}}
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                            ...
                            <span class="text-danger error-text name_err9"></span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3 ">
                            ...
                            <span class="text-danger error-text email_err9"></span>
                        </div>
                        {{--<div class=" col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            ...
                            <span class="text-danger error-text phone_err9"></span>
                        </div>--}}
                        ...
                        <div class=" col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            ...
                            <span class="text-danger error-text phone_err1"></span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            ...
                            <span class="text-danger error-text interested_err1"></span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            ...
                            <span class="text-danger error-text skype_err9"></span>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
                            ...
                            <span class="text-danger error-text message_err9"></span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 Browse">
                            ...
                            <span class="text-danger error-text file_err9"></span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 inquiry-btn d-block m-auto">
                        <button class="btn" type="submit" id="portfolioform"  >
...
$("#portfolioform").on('submit', function (e) {
    ...
    var other_data = $('form#portfolioform').serializeArray();
    $.each(other_data, function (key, input) {
      fd.append(input.name, input.value);
    });
    $.ajax({
      type: 'POST',
      url: "{{ route('footer_form') }}",
      ...
      beforeSend: function () {
        ...
        $("#portfolioform").attr('disabled', true); // disable button
        // $('#fupForm').css("opacity",".5");
      },
      success: function (data) {
        $('#spinner').hide();
        $("#portfolioform").attr('disabled', false);
        if ($.isEmptyObject(data.error)) {
          ...
          printErrorMsgPortfolio(data.error);
        }

      }
    });
  });
  function printErrorMsgPortfolio(msg) {
    $("span.error-text").hide();
    $.each(msg, function (key, value) {
      $('.' + key + '_err9').text(value).show();
    });
  }
