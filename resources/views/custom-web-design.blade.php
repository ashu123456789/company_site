...
<div class="bg-services d-flex align-items-center text-white">
        <div class="container">
            <div class="row">
                ...
                <h1 class="pt-1"><img src="{{ env('APP_CDN_URL') }}/images/technology/custom-design.png" class="services-image" alt="CUSTOM WEB DESIGN" title="CUSTOM WEB DESIGN"> CUSTOM WEB DESIGN</h1>
                    <p class="pt-2 pb-3">Deorwine Infotech is one stop React JS Development Company and gives all React
                        JS services. We also help you to develop a Mobile application that runs seamlessly with a
                        dynamic feature.</p>
                ...
                <div class="col-xl-6 col-lg-6 col-md-5 px-0 banner-right-img" data-aos="fade-left">
                    <img alt="Custom Web Design" title="Custom Web Design" src="{{asset('images/technology/custom-design-banner.webp')}}" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row react-col-rev">
                <div class="col-xl-6 col-lg-6 col-md-12" data-aos="fade-right">
                    <img alt="tech-react-img" title="tech-react-img" src="{{asset('images/technology/tech-react-img.png')}}" class="img-fluid">
                </div>

                <div class="col-xl-6 col-lg-6 col-md-12" data-aos="fade-left" style="overflow-x: visible">
                    <h2 class="pt-1">REACT JS DEVELOPMENT <span>COMPANY</span></h2>
                    <p class="pt-3">We have exceeded in producing world-class ReactJS development services, and we are
                        globally renowned for offering best-fit technology solutions to our clients and focus on making
                        up truly growing web and mobile applications to match the particular business purposes of react
                        js web Development Company.</p>
                    <p class="pb-3">ReactJS is one of the extremely appropriated open-source JavaScript Library that
                        aides in creating outstanding web applications expecting insignificant exertion and coding. We
                        are a React JS development Company that implements logical projects based on the latest
                        technology. React JS is developed to getting the best result and fast rendering data service
                        based in India. </p>
                    <a href="javascript:void(0)" class="btn-primary mb-5" data-toggle="modal" data-target="#exampleModalPreview">Get A Free Quote</a>
                </div>
            </div>
    ...
    <div class="technology-services web-design-services py-5" data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                <h3 class="pt-1 text-center font-h2" data-aos="zoom-in">React Js Development <span>Services</span></h3>
                </div>
            </div>
            <div class="row pt-5">
            ...
            <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <h5 class="my-3">Application Development</h5>
                        <p class="mb-0">Deorwine Infotech is one stop React JS Development Company and gives all React JS services. 
                            We also help you to develop a Mobile application that runs seamlessly and appears with a dynamic feature.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <h5 class="my-3">UI Development</h5>
                        <p class="mb-0">Our UI designers help you to create effective and inherent applications that create greater customer engagement. 
                            We completely leverage the React JavaScript Library to create a beautiful and interactive UI for your Clients.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <h5 class="my-3">Plugin Development</h5>
                        <p class="mb-0">Our web developers have the skills to develop custom plugins that will provide added features to your web applications 
                            that extend the functionality of your web application.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <p class="mb-0">React Js app development services provides adaptable & satisfactory enterprise level applications leverage that helps you 
                            create robust and secure web applications.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <h5 class="my-3">Migration Service</h5>
                        <p class="mb-0">Deorwine Infotech is one stop React JS Development Company and gives all React JS services. We also help you to develop a Mobile 
                            application that runs seamlessly and appears with a dynamic feature.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="design-cards px-3 pb-3 my-4">
                        ...
                        <h5 class="my-3">Support & Maintenance</h5>
                        <p class="mb-0">Deorwine Infotech is one stop React JS Development Company and gives all React JS services. We also help you to develop a Mobile 
                            application that runs seamlessly and appears with a dynamic feature.</p>
                    </div>
                </div>
    ...
    <div class="technology-choose py-5" data-aos="fade-up">
        <div class="container">
            <div class="row react-col-rev">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                <h3 class="font-h2 pt-3" data-aos="zoom-in">Why Choose Deorwine for <span>React Js Development</span></h3>
                    <ul class="pt-3">
    ...
    <div class="development-expertise py-5" data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                <h3 class="font-h2">Our React Development expertise <span>in trending technologies</span></h3>
                    <ul class="pt-3">
                        <li><span>Redux - </span>Framework is used to manage application state. We use Redux above Flux
                            because it does certain concepts possible to implement efficiently which is not probable in
                            Flux.</li>
                        <li><span>React Router 4.0 - </span>React Router 4.0 - React Router v4.0 benefits in the dynamic
                            routing of pages according to the user’s request.</li>
                        <li><span>Thunk Middleware - </span>Redux Middleware for Async Operations.</li>
                        <li><span>Redux DevTools - </span>Tool for debugging application situation dimes.</li>
                        <li><span>Redux Persist - </span>Endure and Rehydrate the Redux building.</li>
                        <li><span>React-Flow - </span>Static type examiner for JavaScript by Facebook.</li>
                    </ul>
                </div>
            </div>
        </div>
