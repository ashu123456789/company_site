...
<div class="bg-services d-flex align-items-center text-white">
        <div class="container">
            <div class="row">
                ...
                <h1 class="pt-1"><img src="{{ env('APP_CDN_URL') }}/images/technology/vr.png" alt="VR" title="VR" class="services-image"> VIRTUAL REALITY APP DEVELOPMENT</h1>
                ...
                <div class="col-xl-6 col-lg-6 col-md-5 px-0 banner-right-img text-center" data-aos="fade-left">
                    <img alt="Virtual Reality" title="Virtual Reality" src="{{asset('images/technology/virtual-reality-banner.png')}}" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="technology-services py-5" data-aos="fade-up">
        <div class="container">
            <div class="row">
                ...
                <h3 class="pt-1 text-center font-h2" data-aos="zoom-in">Virtual Reality App Development <span>Services</span></h3>
                </div>
            </div>
